...
from src.email_plugin.email_handler import EmailScheduleManager
...
class ScheduleService:
    ...
    def create_schedule(self):
        ...
        # Извлекаем week_date_start и week_date_end из первого урока
        if processed_group_lessons:
            ...
            # Фильтруем индивидуальные уроки по дате
